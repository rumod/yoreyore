...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white max-w-md mx-auto relative overflow-hidden shadow-sm">
      ...
      {/* --- Custom Cancel Modal --- */}
      {showCancelModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-[2px] transition-opacity duration-300">
          <div className="bg-white w-full max-w-xs rounded-[2.5rem] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
